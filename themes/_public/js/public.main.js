...
function readUploadInlineURL(input, type) {
  let classes = '.upload-inline .upload-preview'
  if (type) classes = `.upload-inline .upload-preview-${type}`
  $(classes).html("");
